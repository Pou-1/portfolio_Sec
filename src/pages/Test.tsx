    ...
    <div className="w-full h-screen relative flex-center overflow-hidden bg-customDark">
      ...
      <div
        className="card text-white gap-x-5 p-10 relative glassIco h-96 m-8 rounded-3xl 
        			bg-white/5 backdrop-blur-xl border-none flex-center overflow-hidden"
      >
        <div className="text-5xl w-full flex flex-col gap-y-5">
          <h1>Hello I'm</h1>
          <h1 className="font-bold text-[#F32E66]">Emily D'Harambure</h1>
          <p className="text-lg">
            I'm a student in Software & Web Development. I'm currently studying
            in the University of Caen, in Normandie (France) for a University
            Bachelor.
          </p>
        </div>
