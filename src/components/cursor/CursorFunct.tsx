...
export const CursorProvider = ({ children }: { children: ReactNode }) => {
  ...
  const [background, setBackground] = useState("bg-customViolet");
  const [borderWidth, setBorderWidth] = useState("2px");
  const [borderColor, setBorderColor] = useState("border-customViolet");
  ...
  const handleHover = (
    ...
    if (element) {
      ...
      setBackground(options?.background || "bg-customViolet");
      setBorderWidth(options?.borderWidth || "2px");
      setBorderColor(options?.borderColor || "border-customViolet");
  ...
  const resetCursor = () => {
    ...
    setBackground("bg-customViolet");
    setBorderWidth("2px");
    setBorderColor("border-customViolet");
    setIconName(null);
    setText(null);
